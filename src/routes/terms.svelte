<div class="w-full flex  justify-center Topography py-8">
  <div class="w-5/6 xl:w-3/6">
    <h1 class="text-3xl mb-6">Terms &amp; Conditions</h1>
    <p class="pb-2">
      ...
      intellectual property rights related to it, still belong to Brooks Becton.
    </p>
    <p class="pb-2">
      Brooks Becton is committed to ensuring that the app is as useful and
    ...
    <p class="pb-2">
      The Extended Night Companion App app stores and processes personal data
      that you have provided to us, in order to provide my Service. It’s your
      ...
      security features and it could mean that the Extended Night Companion App
    ...
    <p class="pb-2">
      You should be aware that there are certain things that Brooks Becton will
      ...
      provided by your mobile network provider, but Brooks Becton cannot take
    ...
    <p class="pb-2">
      Along the same lines, Brooks Becton cannot always take responsibility for
      ...
      Service, Brooks Becton cannot accept responsibility.
    </p>
    <p class="pb-2">
      With respect to Brooks Becton’s responsibility for your use of the app,
      ...
      available to you. Brooks Becton accepts no liability for any loss, direct
    ...
    <p class="pb-2">
      ...
      using the app. Brooks Becton does not promise that it will always update
    ...
    <h2 class="text-2xl my-4">Changes to This Terms and Conditions</h2>
    <p class="pb-2">
    ...
    <p class="pb-2">
      ...
      not hesitate to contact me at <a
        class="text-primary"
        href="mailto:dirtydogsoftware88@gmail.com"
        >dirtydogsoftware88@gmail.com
      </a>.
    </p>
    <p class="pb-2">
