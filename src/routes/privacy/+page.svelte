<div class="w-full flex  justify-center Topography py-8">
  <div class="w-5/6 xl:w-3/6">
    ...
    <p class="pb-2">
      Brooks Becton built the Extended Night Companion app as an Ad Supported
      app. This SERVICE is provided by Brooks Becton at no cost and is intended
      for use as is.
    </p>
    <p class="pb-2">
    ...
    <p class="pb-2">
      ...
      Terms and Conditions, which is accessible at Extended Night Companion
    ...
    <ul>
      <li class="list-disc ml-8">To facilitate our Service;</li>
      <li class="list-disc ml-8">To provide the Service on our behalf;</li>
      <li class="list-disc ml-8">To perform Service-related services; or</li>
      <li class="list-disc ml-8">
    ...
    <p>
      ...
      external sites are not operated by me. Therefore, I h2ly advise you to
    ...
    <h2 class="text-2xl my-4">Children’s Privacy</h2>
    <p>
